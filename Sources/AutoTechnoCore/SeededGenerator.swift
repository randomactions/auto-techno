package struct SeededGenerator: Sendable {
    ...
    package mutating func chance(_ probability: Double) -> Bool {
    ...
    package mutating func value(in range: ClosedRange<Double>) -> Double {
