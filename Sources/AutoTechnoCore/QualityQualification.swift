...
package enum QualityQualificationContract {
    ...
    /// its atomic commit at an unscheduled future boundary. Quality schema 26
    /// adds score-owned pad rhythmic-modulation evidence and advances
    ...
    package static let engineVersion = "autotechno-canonical-engine.v25"
