...
engine `autotechno-canonical-engine.v29`, quality-contract schema 30,
candidate-vector schema 28, candidate-transaction schema 4, Professional
Evidence v14, professional profile v11, and primary policy/evaluator v11. It is not
...
source occurrence, sample range, route, engine, Professional Evidence v14,
...
The controller reads those two bounds from the exact installed profile v11.
...
The bundled v11 profile, v12 adversarial suite, and v10 disjoint holdout are the only
...
replay establish implementation and offline policy evidence for engine v29.
