...
engine `autotechno-canonical-engine.v28`, quality-contract schema 29,
candidate-vector schema 27, candidate-transaction schema 4, Professional
Evidence v13, professional profile v10, and primary policy/evaluator v10. It is not
...
source occurrence, sample range, route, engine, Professional Evidence v13,
...
The controller reads those two bounds from the exact installed profile v10.
...
The bundled v10 profile, v11 adversarial suite, and v9 disjoint holdout are the only
...
replay establish implementation and offline policy evidence for engine v28.
