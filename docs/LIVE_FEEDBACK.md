...
engine `autotechno-canonical-engine.v30`, quality-contract schema 31,
candidate-vector schema 29, candidate-transaction schema 4, Professional
Evidence v15, professional profile v12, and primary policy/evaluator v12. It is not
...
source occurrence, sample range, route, engine, Professional Evidence v15,
...
The controller reads those two bounds from the exact installed profile v12.
...
The bundled v12 profile, v13 adversarial suite, and v11 disjoint holdout are the only
...
replay establish implementation and offline policy evidence for engine v30.
