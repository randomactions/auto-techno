...
engine `autotechno-canonical-engine.v27`, quality-contract schema 28,
candidate-vector schema 26, candidate-transaction schema 4, Professional
Evidence v12, professional profile v9, and primary policy/evaluator v9. It is not
...
source occurrence, sample range, route, engine, Professional Evidence v12,
...
The controller reads those two bounds from the exact installed profile v9.
...
The bundled v9 profile, v10 adversarial suite, and v8 disjoint holdout are the only
...
replay establish implementation and offline policy evidence for engine v27.
