...
engine `autotechno-canonical-engine.v48`, quality-contract schema 49,
candidate-vector schema 43, candidate-transaction schema 14, Professional
Evidence v29, professional profile v29, primary policy/evaluator v29, and live
...
source occurrence, sample range, route, engine, Professional Evidence v29,
...
The controller reads those two bounds from the exact installed profile v29.
