...
engine `autotechno-canonical-engine.v43`, quality-contract schema 44,
candidate-vector schema 38, candidate-transaction schema 9, Professional
Evidence v23, professional profile v24, primary policy/evaluator v24, and live
...
source occurrence, sample range, route, engine, Professional Evidence v24,
...
The controller reads those two bounds from the exact installed profile v24.
