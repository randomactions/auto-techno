...
The nonlinear topology remains current under engine v48, whose exact artifacts
...
Engine identity `autotechno-canonical-engine.v48`, quality-contract schema 49,
candidate-vector schema 43, and candidate-transaction schema 14 identify the
