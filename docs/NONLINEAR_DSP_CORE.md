...
The nonlinear topology remains current under engine v38, whose exact artifacts
...
Engine identity `autotechno-canonical-engine.v38`, quality-contract schema 39,
candidate-vector schema 35, and candidate-transaction schema 6 identify the
