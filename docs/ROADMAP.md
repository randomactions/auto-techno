...
- canonical engine v25, quality-contract schema 26, candidate-vector schema 24,
  ...
  protagonist spectral-reveal and Resonant Mono nonlinear-core consequence,
...
- phrase-wide and live-window ITU-R BS.1770-5 loudness, Annex 2 true peak,
  ...
  Professional Evidence v10 report bank;
...
The app now installs one exact-engine calibrated primary evaluator v7 from the
current profile v7 derived from 28 complete journeys, a passing v8 adversarial
...
Quality-contract schema 26, candidate-vector schema 24, and candidate-
transaction schema 4 now bind a versioned transaction across canonical engine
v25, quality policy, evaluator, candidate
...
spectral, masking, and pole-stability evidence. Professional Evidence v10 adds
...
guardrails, a passing 27-case v8 adversarial suite, and a disjoint holdout report
...
and controller state into continuation. The exact engine-v25 profile v7,
passing v8 adversarial suite, disjoint holdout qualification, non-compensable
