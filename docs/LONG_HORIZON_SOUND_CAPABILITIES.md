...
effect. Phase 6A now supplies compatible realized signal trajectories from the
same accepted prepared phrase, with the semantic target and physical consequence
kept separate. The next gate is calibrated development, adversarial, and
disjoint holdout policy. Only a repeatable trajectory or translation deficit
