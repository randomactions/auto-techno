...
4. `AutonomousPhrasePreparer` renders immutable attempts into one versioned
   ...
   A deterministic Professional Evidence v17
...
status. Candidate-vector schema 31 binds these observations to the score bar,
...
full/protected pass equality into candidate-vector schema 31. Professional
...
equality. Professional Evidence v17 adds one upper-only safer silence-RMS
...
candidate-vector schema 31 reduces those tuples into exact score/render and
