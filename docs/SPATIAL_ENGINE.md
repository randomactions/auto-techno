...
The spatial topology remains part of engine v44 together with material-world
...
5. `SpatialFDNRenderEvidence` streams hashes and reduced measurements from the
   ...
   record to every rendered bar under quality-contract schema 45, candidate-
   transaction schema 9, and canonical engine v44.
