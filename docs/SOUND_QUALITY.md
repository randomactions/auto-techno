...
candidate uses quality-contract schema 28, candidate-vector schema 26,
candidate-transaction schema 4, and canonical engine identity
`autotechno-canonical-engine.v27`. It preserves
...
`ProfessionalEvidenceReportBank` v12 accepts a bank only when every canonical
...
exact-engine primary evaluator v9 from the v9 profile, v10 adversarial suite,
and v8 disjoint holdout. It judges every
...
Candidate-vector schema 26 binds that record to the matching instrument effect
...
Candidate-vector schema 26 retains one compact record per full rendered bar. It
...
Under quality-contract schema 28, candidate-vector schema 26,
candidate-transaction schema 4, and canonical engine v27, the versioned
